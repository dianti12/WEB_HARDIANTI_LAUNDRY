                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image ">
                                <img style=" margin-top : 50px; margin-left:45px; width: 350px; height:400px;" src="./img/logo1.png" alt="">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Welcome Laundry System</h1>
                                    </div>
                                    <form action="" method="POST" class="user">
                                        ...
                                        <button type="submit" name="login" href="" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </button>
                                        <hr>
